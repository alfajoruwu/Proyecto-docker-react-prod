...
const FormularioCrearEjercicio = ({ listaDB, ActualizarEjercicios }) => {
    ...
    const { NombreEjercicio, SetNombreEjercicio, SetterNombreEjercicio, ResumenEjercicio, SetResumenEjercicio, SetterResumenEjercicio, ProblemaEjercicio, SetProblemaEjercicio, SetterProblemaEjercicio,
        ...
        ListaTopicosEjercicios, SetListaTopicosEjercicios, SetterListaTopicosEjercicios } = useContext(EstadoGlobalContexto)
    ...
    const MostrarFormulario = () => {
        ...
        apiClient.post('/ejericicios/CrearEjercicio', { nombre: NombreEjercicio, problema: ProblemaEjercicio, descripcion: ResumenEjercicio, solucionSQL: SolucionEjercicio, dbId: IDDBSeleccionadaEjercicio, dificultad: DificultadEjercicio, permitirIA: PermitirIAEjercicio, verRespuestaEsperada: VerRespuestaEsperada, topicos: topicosSeleccionados })
            .then(response => { console.log('Usuarios:', response.data); mostrarToast(response.data.message, 'success', 3000); LimpiarFormulario(); document.getElementById('Crear_db').close(); ActualizarEjercicios(); })
